...
from .kviews.vendor_view import VendorUserViewSet, UploadVendorSpreadSheetViewSet, VendorOnlyViewSet
...
router.register(r'vendorsByAddress', VendorOnlyViewSet, basename="vendorsByAddress")
